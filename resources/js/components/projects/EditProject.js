    ...
    <div className="card  bg-dark">
      ...
      {this.state.isLoading && 
        <div className="row">
          ...
          <div className="col-md-7"><strong><span className="text-success h3">Prtoject Updated</span></strong></div>
        </div>
        }
        ...
        <div className="row">
          ...
          <div className="col-md-7"><strong><span className="text-danger h3">Update Project</span></strong></div>
        </div>
        }
      </div>
      <div className="card-body text-light">
        <form  onSubmit={this.submitForm}>
          ...
          {!this.state.isLoading && <input type="submit" className="btn btn-info form-control text-light" value="Update"/>}

          {this.state.isLoading && <input type="button" className="btn bg-success form-control text-light disable" value="Updated"/>}
